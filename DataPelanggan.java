...
int nomor=1;
DefaultTableModel lina=new DefaultTableModel();
lina.addColumn("No");
lina.addColumn("Kode Barang");
lina.addColumn("Nama Barang");
lina.addColumn("Harga");
lina.addColumn("Supplier");
...
sql = "SELECT * FROM barang,supplier WHERE barang.kd_sup=supplier.kd_sup";
    ...
    while (res.next()) {
    lina.addRow(new Object[]{nomor++,res.getString(1),res.getString(2),res.getString(3),res.getString(6)});
  //  Object nextElement = res.nextElement();
            
        }
    pelanggan.setModel(lina);
